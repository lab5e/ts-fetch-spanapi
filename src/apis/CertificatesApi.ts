...
export class CertificatesApi extends runtime.BaseAPI {
     ...
     * Create certificate
     */
    async createCertificateRaw(requestParameters: CreateCertificateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateCertificateResponse>> {
     ...
     * Create certificate
     */
    async createCertificate(requestParameters: CreateCertificateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateCertificateResponse> {
     ...
     * Sign certificate
     */
    async signCertificateRaw(requestParameters: SignCertificateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SignCertificateResponse>> {
        if (requestParameters.collectionId === null || requestParameters.collectionId === undefined) {
     ...
     * Sign certificate
     */
    async signCertificate(requestParameters: SignCertificateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SignCertificateResponse> {
     ...
     * Verify certificate
     */
    async verifyCertificateRaw(requestParameters: VerifyCertificateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VerifyCertificateResponse>> {
        if (requestParameters.collectionId === null || requestParameters.collectionId === undefined) {
     ...
     * Verify certificate
     */
    async verifyCertificate(requestParameters: VerifyCertificateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VerifyCertificateResponse> {
