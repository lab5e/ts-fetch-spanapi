...
export class OutputsApi extends runtime.BaseAPI {
     ...
     * Create output
     */
    async createOutputRaw(requestParameters: CreateOutputOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Output>> {
     ...
     * Create output
     */
    async createOutput(requestParameters: CreateOutputOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Output> {
     ...
     * Update output
     */
    async updateOutputRaw(requestParameters: UpdateOutputOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Output>> {
     ...
     * Update output
     */
    async updateOutput(requestParameters: UpdateOutputOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Output> {
