...
export class DevicesApi extends runtime.BaseAPI {
     ...
     * Send message
     */
    async sendMessageRaw(requestParameters: SendMessageRequest): Promise<runtime.ApiResponse<SendMessageResponse>> {
        if (requestParameters.collectionId === null || requestParameters.collectionId === undefined) {
     ...
     * Send message
     */
    async sendMessage(requestParameters: SendMessageRequest): Promise<SendMessageResponse> {
