...
import {
    AddDownstreamMessageBodyFromJSON,
    AddDownstreamMessageBodyToJSON,
    CreateDeviceBodyFromJSON,
    CreateDeviceBodyToJSON,
    ...
    RpcStatusFromJSON,
    RpcStatusToJSON,
    UpdateDeviceBodyFromJSON,
    UpdateDeviceBodyToJSON,
} from '../models';
...
export class DevicesApi extends runtime.BaseAPI {
     ...
     */
    async addDownstreamMessageRaw(requestParameters: AddDownstreamMessageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MessageDownstream>> {
        ...
        const response = await this.request({
            ...
            body: AddDownstreamMessageBodyToJSON(requestParameters.body),
        }, initOverrides);
     ...
     * Add message to oubox
     */
    async addDownstreamMessage(requestParameters: AddDownstreamMessageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MessageDownstream> {
    ...
    async createDeviceRaw(requestParameters: CreateDeviceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Device>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateDeviceBodyToJSON(requestParameters.body),
        }, initOverrides);
    ...
    async updateDeviceRaw(requestParameters: UpdateDeviceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Device>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateDeviceBodyToJSON(requestParameters.body),
        }, initOverrides);
