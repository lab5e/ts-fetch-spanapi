...
export class DatadumpApi extends runtime.BaseAPI {
     ...
     * Data dump
     */
    async dataDumpRaw(requestParameters: DataDumpRequest): Promise<runtime.ApiResponse<DataDumpResponse>> {
     ...
     * Data dump
     */
    async dataDump(requestParameters: DataDumpRequest): Promise<DataDumpResponse> {
