...
import {
    CreateGatewayRequestFromJSON,
    CreateGatewayRequestToJSON,
    GatewayFromJSON,
    GatewayToJSON,
    ...
    StatusFromJSON,
    StatusToJSON,
    UpdateGatewayRequestFromJSON,
    UpdateGatewayRequestToJSON,
} from '../models';

export interface CreateGatewayOperationRequest {
    collectionId: string;
...
export interface UpdateGatewayOperationRequest {
...
export class GatewaysApi extends runtime.BaseAPI {
     ...
     * Create gateway
     */
    async createGatewayRaw(requestParameters: CreateGatewayOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Gateway>> {
        ...
        const response = await this.request({
            ...
            body: CreateGatewayRequestToJSON(requestParameters.body),
        }, initOverrides);
     ...
     * Create gateway
     */
    async createGateway(requestParameters: CreateGatewayOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Gateway> {
     ...
     * Update gateway
     */
    async updateGatewayRaw(requestParameters: UpdateGatewayOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Gateway>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateGatewayRequestToJSON(requestParameters.body),
        }, initOverrides);
     ...
     * Update gateway
     */
    async updateGateway(requestParameters: UpdateGatewayOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Gateway> {
