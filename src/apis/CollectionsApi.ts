...
export class CollectionsApi extends runtime.BaseAPI {
     ...
     * Broadcast message
     */
    async broadcastMessageRaw(requestParameters: BroadcastMessageRequest): Promise<runtime.ApiResponse<MultiSendMessageResponse>> {
     ...
     * Broadcast message
     */
    async broadcastMessage(requestParameters: BroadcastMessageRequest): Promise<MultiSendMessageResponse> {
