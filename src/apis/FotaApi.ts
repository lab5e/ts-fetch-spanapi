...
export class FotaApi extends runtime.BaseAPI {
     ...
     * Create firmware
     */
    async createFirmwareRaw(requestParameters: CreateFirmwareRequest): Promise<runtime.ApiResponse<Firmware>> {
        if (requestParameters.collectionId === null || requestParameters.collectionId === undefined) {
     ...
     * Create firmware
     */
    async createFirmware(requestParameters: CreateFirmwareRequest): Promise<Firmware> {
