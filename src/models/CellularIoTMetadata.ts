...
/**
 * Check if a given object implements the CellularIoTMetadata interface.
 */
export function instanceOfCellularIoTMetadata(value: object): boolean {
    let isInstance = true;
...
export function CellularIoTMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CellularIoTMetadata {
    ...
    return {
        ...
        'lastImsi': !exists(json, 'lastImsi') ? undefined : json['lastImsi'],
